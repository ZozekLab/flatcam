...
class LinuxCNC_ZozekLab(PreProc):
    ...
    def start_code(self, p):
        ...
        gcode = '(FlatCAM Evo preprocessor for LinuxCNC.)\n'
        gcode += '(Custom LinuxCNC_ZozekLab v0.2 - based on FlatCAM Evo default.py.)\n'
        gcode += '(Work coordinate system: G54.)\n\n'
